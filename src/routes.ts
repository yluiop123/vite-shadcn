...
const routeSetting: NavItem[] = [
  ...
  },
  {
    ...
    icon: Puzzle,
    children: [
      { key: "general", title: "menu.component.general", icon: Square },
      { key: "layout", title: "menu.component.layout", icon: Columns },
      { key: "navigation", title: "menu.component.navigation", icon: Share2 },
      { key: "display", title: "menu.component.display", icon: Monitor },
      { key: "feedback", title: "menu.component.feedback", icon: Bell },
