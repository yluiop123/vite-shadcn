export default {
    ...
    'menu.dashboard.disaster-command': 'Disaster Command',
    'menu.dashboard.agriculture-forestry': 'Agriculture & Forestry',
    'menu.dashboard.industrial': 'Industrial Management',
