...
export default function LayoutPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight">Layout 组件</h1>
            ...
            <LayoutSection hasSider={true}>
              ...
              <Content>
                <div className="space-y-4">
                  <h2 className="text-2xl font-semibold">主内容区域</h2>
                  <p>这是主要内容区域，可以根据需要放置各种组件和内容。</p>
            ...
            <div className="border rounded-lg overflow-hidden">
              <Layout>
                <Header className="bg-secondary">
                  <h2 className="text-lg font-medium">受控布局</h2>
                </Header>
                ...
                <LayoutSection hasSider={true}>
                  ...
                  <Content>
                    <p>这是一个使用受控折叠状态的侧边栏示例。</p>
                    <p>可以通过外部按钮控制侧边栏的折叠/展开状态。</p>
                  </Content>
                </LayoutSection>
              </Layout>
            </div>
          ...
          <div className="space-y-6">
              ...
              <Layout>
                <Header className="bg-secondary">
                  <div className="flex items-center gap-2">
                    <span>自定义图标示例</span>
                    <span className="text-xs text-muted-foreground">(默认方向)</span>
                  </div>
                </Header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border rounded-lg overflow-hidden">
                <Layout>
                  <Header className="bg-secondary">
                    <span className="text-sm">圆形图标</span>
                  </Header>
              ...
              <div className="border rounded-lg overflow-hidden">
                <Layout>
                  <Header className="bg-secondary">
                    <span className="text-sm">方形图标</span>
                  </Header>
